...
pdfmetrics.registerFont(TTFont('FreeSansBold', 'project/src/invoices/fonts/FreeSansBold.ttf'))
pdfmetrics.registerFont(TTFont('FreeSans', 'project/src/invoices/fonts/FreeSans.ttf'))
